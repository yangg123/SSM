...
import com.ssm.dao.impl.ZhihuDaoImpl;
...
public class ZhiHuUserPageProcessor implements PageProcessor{
    ...
    public void process(Page page) {
        ...
        //2. 如果是用户详细页面
            ...
            int agree = 1;//Integer.parseInt(page.getHtml().xpath("//span[@class='zm-profile-header-user-agree']/strong/text()").get());
            int thanks = 1;//Integer.parseInt(page.getHtml().xpath("//span[@class='zm-profile-header-user-thanks']/strong/text()").get());
            int ask = 1;//Integer.parseInt(page.getHtml().xpath("//div[@class='profile-navbar clearfix']/a[2]/span[@class='num']/text()").get());
            int answer = 1;//Integer.parseInt(page.getHtml().xpath("//div[@class='profile-navbar clearfix']/a[3]/span[@class='num']/text()").get());
            int article = 1;//Integer.parseInt(page.getHtml().xpath("//DBHelperdiv[@class='profile-navbar clearfix']/a[4]/span[@class='num']/text()").get());
            int collection = 1;//Integer.parseInt(page.getHtml().xpath("//div[@class='profile-navbar clearfix']/a[5]/span[@class='num']/text()").get());
